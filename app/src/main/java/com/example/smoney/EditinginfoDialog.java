...
public class EditinginfoDialog extends AppCompatDialogFragment {
    ...
    public EditinginfoDialog(Item _item,HistoryFragment _his){
        historyFragment=_his;
        item=_item;
    }
        ...
        builder.setView(view)
                ...
                .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        WriteNoti.create_noti("sua", String.valueOf(itemtemp.TypeToEnty(numcate)), getContext());
